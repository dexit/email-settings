...
class CustomEmail
{
    ...
    /*
        ...
        $args["url"] - a custom URL that will be used in E-Mail letter (i.e activation url/reset password url/etc.)
    ...
    */
    public static function generate(array $args)
    {
        ...
        */
        if(isset($args["variables_values"]) && is_array($args["variables_values"]))
        {
    ...
    */
    protected static function send_email($args,$user,$title,$message)
    {
        ...
        */
        ...
        /*
            Add a PHPMailer callback function if it's set
        */
